              ...
              <div class="col-12">
                <div class="p-2">
                  <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="example-email"
                        >Email</label
                      >
                      <div class="col-sm-10">
                        <input
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="example-date"
                        >Date</label
                      >
                      <div class="col-sm-10">
                        <input
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="example-month"
                        >Month</label
                      >
                      <div class="col-md-10">
                        <input
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="example-time"
                        >Time</label
                      >
                      <div class="col-md-10">
                        <input
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="example-week"
                        >Week</label
                      >
                      <div class="col-md-10">
                        <input
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="example-color"
                        >Color</label
                      >
                      <div class="col-md-10">
                        <input
                    ...
                    <div class="form-group row mb-0">
                      <label class="col-sm-2 col-form-label" for="example-range"
                        >Range</label
                      >
                      <div class="col-md-10">
                        <b-form-input
                ...
                <div class="mt-3">
                  <b-form-group>
                    <b-form-radio
                      ...
                      name="some-radios"
                      value="A"
                      >Toggle this custom radio</b-form-radio
                    >
                    <b-form-radio
                      v-model="selected"
                      name="some-radios"
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">
              ...
              <code>.input-lg</code>, and set widths using grid column classes
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <b-form inline>
                  ...
                  <label class="sr-only" for="inline-form-input-username2"
                    >Username</label
                  >
                  <b-input-group prepend="@" class="mb-2 mr-sm-2 mb-sm-0">
                    <b-input
