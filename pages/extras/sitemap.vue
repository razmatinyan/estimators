              ...
              <div class="col-lg-4">
                <ul class="sitemap">
                  <li>
                    ...
                    >
                      <!-- <img src="~/assets/images/logo-sm-dark.png" alt height="12" class="mr-1" /> Estimators Pages -->
                      <img
                ...
                <ul class="sitemap">
                  <li>
                    <a
                      ...
                      class="text-uppercase font-weight-bold"
                    >
                      <!-- <img src="~/assets/images/logo-sm-dark.png" alt height="12" class="mr-1" /> Estimators -->
                      <img
                        src="~/assets/images/logo.png"
                        alt
                        height="12"
