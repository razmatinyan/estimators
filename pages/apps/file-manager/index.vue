...
export default {
  ...
  data() {
    return {
      ...
      fileManagerData: [
        ...
        //   size: '125 MB',
        //   users: [
        //     require('~/assets/images/users/usericon.svg'),
  ...
  computed: {
    ...
    isClient() {
      return this.checkUserRole('client') ? '-client' : ''
    }
  },
  methods: {
    saveFile(event) {
      for (let i = 0; i < event.target.files.length; i++) {
        ...
        this.fileManagerData.push({
          ...
          date,
          size,
          users: [require('~/assets/images/users/usericon.svg')]
        })
      }
    }
  }
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <router-link
              :to="`/apps/file-manager/nda` + isClient"
              class="fileupload btn btn-success waves-effect waves-light mb-3"
            >
              <span>
                <i class="mdi mdi-pencil-lock-outline mr-1"></i> NDA
              </span>
            </router-link>
            <router-link
              :to="`/apps/file-manager/contract` + isClient"
              class="fileupload btn btn-success waves-effect waves-light mb-3"
            >
              <span> <i class="mdi mdi-lead-pencil mr-1"></i> Contract </span>
            </router-link>
            <!-- <div
              class="fileupload btn btn-success waves-effect waves-light mb-3"
            >
            ...
            <div class="table-responsive">
              <table class="table table-centered mb-0">
                ...
                <tbody>
                  <template v-if="fileManagerData.length">
                    <tr
                  ...
                  <tr v-else>
                    <td style="color: #b7b7b7">Nothing to show</td>
                  </tr>
                </tbody>
              </table>
            </div>
