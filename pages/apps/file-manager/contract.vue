    ...
    <div class="contract px-4 mx-auto">
      ...
      <div class="body mb-3">
        <span class="indent">
          ...
          <span>
            by and between
            <span class="underline font-bold">AV Promotions</span> located at
          ...
          <p class="flex mt-1 flex-wrap">
            <span class="mr-2">located at </span>
            <input
              type="text"
              class="flex-1"
              placeholder="Contractor address"
              v-model="contract.contractor.address"
            />
          </p>
          <p class="mt-1">
            <Multiselect
            ...
            (“Independent Contractor”). Client and Independent Contractor may
            each be referred to in this Agreement as a “Party” and collectively
            as the “Parties.”
          </p>
        </span>
