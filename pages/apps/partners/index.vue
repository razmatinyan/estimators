  ...
  methods: {
    ...
    handleSubmit(e) {
      ...
      if (this.$v.$invalid) {
        ...
        this.partners.push({
          logo: require('~/assets/images/partners/amazon.png'),
          name,
          location
        })
...
<template>
  <div>
    ...
    <div class="row">
      <div
        v-for="partnersdata in partners"
        :key="partnersdata.name"
      ...
      >
        <div class="card">
          <div class="card-body">
            ...
            <hr v-if="partnersdata.revenue" />
            <div class="text-muted">
              <div class="row">
                <div class="col-6">
                  <div>
                    <p class="text-truncate mb-0">Revenue (USD)</p>
                    <h5 class="mb-sm-0">{{ partnersdata.revenue }}</h5>
                  </div>
                </div>
                <div class="col-6">
                  <div>
                    <p class="text-truncate mb-0">Number of employees</p>
                    <h5 class="mb-sm-0">{{ partnersdata.employees }}</h5>
                  </div>
                </div>
              </div>
            </div>
