...
<template>
  <div>
    ...
    <div class="row mb-2">
      <div class="col-sm-4">
        <nuxt-link :to="localPath('/projects/product-create')" class="btn btn-danger mb-2"
          ><i class="mdi mdi-plus-circle mr-1"></i> Add Products</nuxt-link
        >
      </div>
      <div class="col-sm-8">
          ...
          <div class="product-info border-top p-3">
            <div>
              <h5 class="font-16 mt-0 mb-1">
                <nuxt-link
                  :to="localPath(`/projects/product-detail/${item.id}`)"
                  class="text-dark"
                  >{{ item.name }}</nuxt-link
                >
              </h5>
