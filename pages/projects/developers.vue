                  ...
                  <tab-content title="Billing Info">
                    ...
                    <ul class="pager wizard list-inline mt-2">
                      <li class="list-inline-item">
                        <nuxt-link :to="localPath('/projects/cart')" class="btn btn-secondary"
                      ...
                      <table class="table table-centered table-nowrap mb-0">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <nuxt-link
                                :to="localPath('/projects/product-detail/1')"
                                class="text-body font-weight-semibold"
                                >Blue color T-shirt</nuxt-link
                              >
                          ...
                          <tr>
                            ...
                            <td>
                              <nuxt-link
                                :to="localPath('/projects/product-detail/1')"
                                class="text-body font-weight-semibold"
                                >Full sleeve Pink T-shirt</nuxt-link
                              >
