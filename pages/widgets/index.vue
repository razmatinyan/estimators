            ...
            <div class="row">
              <div class="col-6">
                <div :class="`avatar-lg rounded-circle bg-icon-${data.color} `">
                  <i
                    :class="`${data.icon} font-24 avatar-title text-white`"
                  ></i>
                </div>
              </div>
              <div class="col-6">
        ...
        <div class="card widget-icon">
          <div class="card-body">
            <div class="avatar-lg float-left">
              <i
                :class="
                  `${widgetdata.icon} text-${widgetdata.iconcolor} avatar-title display-4 m-0`
                "
              ></i>
            </div>
            <div class="wid-icon-info text-right">
              <p class="text-muted mb-1 font-13 text-uppercase">
                {{ widgetdata.title }}
              </p>
              ...
              <div class="card-body">
                ...
                <div class="widget-chart text-center">
                  ...
                  <apexchart
                    ...
                    :options="revenueBarChart.chartOptions"
                  ></apexchart>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <apexchart
                  ...
                  :options="revenueLineChart.chartOptions"
                ></apexchart>
              ...
              <div class="card-body">
                ...
                <div class="widget-chart text-center">
                  <apexchart
                    height="200"
                    type="line"
                    :series="revenueRealTimeChart.series"
                    :options="revenueRealTimeChart.chartOptions"
                  ></apexchart>
                  <div class="row mt-3">
                    <div class="col-4">
                      <p class="text-muted font-15 mb-1 text-truncate">
              ...
              <div class="card-body">
                ...
                <div class="widget-chart text-center">
                  <apexchart
                    height="200"
                    type="bar"
                    :series="revenueLineColumnChart.series"
                    :options="revenueLineColumnChart.chartOptions"
                  ></apexchart>
                  <div class="row mt-3">
                    <div class="col-4">
                      <p class="text-muted font-15 mb-1 text-truncate">
