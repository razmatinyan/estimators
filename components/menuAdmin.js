export const menuItemsAdmin = [
  ...
  },
  {
    ...
    subItems: [
      {
        id: 3,
        label: 'menuitems.dashboard.list.estimates',
  ...
  },
  {
    ...
    // badge: {
    //   variant: 'danger',
    //   text: 'menuitems.projects.badge'
    // },
    isMenuCollapsed: false,
    subItems: [
      {
        id: 11,
        label: 'menuitems.projects.list.createproject',
        link: '/projects/project-create'
      },
      {
        id: 12,
        label: 'menuitems.projects.list.client',
        link: '/projects/client'
      },
      {
        id: 13,
        label: 'menuitems.projects.list.estimating',
        link: '/projects/estimating'
      },
      {
        id: 15,
        label: 'menuitems.projects.list.developers',
