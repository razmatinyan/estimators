        ...
        <b-tabs content-class="pt-0" justified class="nav-bordered">
          <b-tab active>
            <template v-slot:title>
              <i
                class="mdi mdi-message-text-outline d-block font-22 my-1 text-pageBlue"
              ></i>
            </template>
            ...
            <div class="p-2">
              ...
              >
                <div class="media">
                  <div class="position-relative mr-2">
                    <span class="user-status rightMenu"></span>
                    <img
              ...
              >
                <div class="media">
                  <div class="position-relative mr-2">
                    <span class="user-status rightMenu"></span>
                    <!-- <img
                      src="~/assets/images/users/usericon.svgg"
                      class="rounded-circle avatar-sm"
                      alt="user-pic"
                    /> -->
                    <div
                      class="rounded-circle avatar-sm flex justify-center items-center text-white"
              ...
              >
                <div class="media">
                  <div class="position-relative mr-2">
                    <span class="user-status rightMenu busy"></span>
                    <img
            ...
            <div class="p-2 pb-4">
              ...
              >
                <div class="media">
                  <div class="position-relative mr-2">
                    <span class="user-status rightMenu online"></span>
                    <img
              ...
              >
                <div class="media">
                  <div class="position-relative mr-2">
                    <span class="user-status rightMenu away"></span>
                    <img
          ...
          <b-tab>
            <template v-slot:title>
              <i
                class="mdi mdi-format-list-checkbox d-block font-22 my-1 text-pageBlue"
              ></i>
            </template>
