...
import { menuItemsAdmin } from './menuAdmin'
...
<template>
  ...
  <div class="left-side-menu">
    ...
    <div class="logo-box" style="background-color: #841F3B !important">
      <nuxt-link :to="localePath('/')" class="logo logo-dark text-center" style="height: 100%">
        <span class="logo-sm">
          ...
          <img
            ...
            style="height: 100%"
          />
          <!-- <span class="logo-lg-text-light">Estimators</span> -->
        </span>
        <span class="logo-lg">
      ...
      <nuxt-link
        ...
        style="height: 100%"
      >
        <span class="logo-sm" style="height: 100%">
        ...
        <span class="logo-lg" style="height: 100%">
          ...
          <img src="~/assets/images/logo-white.svg" style="height: 100%" />
        </span>
      </nuxt-link>
    </div>
        ...
        <ul class="list-unstyled" id="side-menu">
          <template v-for="item in getMenuItems">
            ...
            <li v-if="!item.isTitle && !item.isLayout" :key="item.id">
              ...
              >
                <i :class="`${item.icon} text-pageBlue`" v-if="item.icon"></i>
